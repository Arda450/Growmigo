...
>(
  (
    ...
    const baseClasses = cn(
      "group inline-flex items-center px-8 py-3 text-white font-more-sugar text-lg md:text-xl",
    ...
    const ArrowSVG = () => (
      ...
      >
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <path
            className={cn(
              "transition-all duration-300 transform fill-white",
              // Desktop hover
              "group-hover:translate-x-0 group-hover:animate-pulse",
              // Default position
              "-translate-x-[60%]",
              // Mobile touch states
              (isPressed || isTouched) && "translate-x-0 animate-pulse"
            )}
          ...
          <path
            className={cn(
              "transition-all duration-400 transform fill-white",
              "group-hover:translate-x-0 group-hover:animate-pulse",
              "-translate-x-[30%]",
              (isPressed || isTouched) && "translate-x-0 animate-pulse"
            )}
          ...
          <path
            className={cn(
              "transition-all duration-500 fill-white",
              "group-hover:animate-pulse",
              (isPressed || isTouched) && "animate-pulse"
            )}
